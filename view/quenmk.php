                ...
                <div class="ct" style="border-radius:20px;;height:50%;width:180%;margin-left:-43%;margin-top:15%; ">
                    ...
                    <form action="" method="post">
                        <div class="form1" style="text-align:center;">
                            <div>
                                ...
                                <input type="text" class="bg-inherit" name="email"
                                    style="padding: 8px 0;width:50%;border-radius:10px;border:1px solid #FFCACA"
                                    required>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form3" style="text-align:center;margin-bottom:15px;">
                            <input type="submit" value="Send" name="guiemail"
                                class=" mx-2 hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:scale-105"
                                style="border: 1px solid #fff;border-radius: 10px;color: #fff;padding: 8px 35px; cursor: pointer;">
                            <input type="reset" value="Reset"
                                class=" duration-100 mx-2 hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:bg-stone-500"
                                style="border: 1px solid #fff;border-radius: 10px;color: #fff;padding: 8px 35px; cursor: pointer">
                        ...
                        <div class="form4" style="text-align:center;">
                            <button class="bg-gradient-to-r from-purple-500 to-pink-500 "
                                style="border: 1px solid #fff;border-radius: 10px;padding: 8px 35px; cursor: pointer">
                                <a href="../index.php?act=home" style="color: #FFCACA;text-decoration: none;">Trở về
                                    trang chủ</a>
                            </button>
                        </div>
                    ...
                    if(isset($thongbao)&&($thongbao!="")){?>
                            ...
                            <div class="w-1/3 h-1/3 text-center fixed inset-y-60 inset-x-1/4 rounded-lg shadow-2xl border-solid z-10 bg-white"
                                style="margin-left:133px;">
                                <i
                                    class="text-green-500 py-10  text-6xl text-center fa-sharp fa-solid fa-circle-check"></i>
                                <p class="text-black py-8 text-3xl text-center"><?php echo $thongbao;?></p>

                                <div class="form4" style="text-align:center;">
                                    <button class="bg-gradient-to-r from-purple-500 to-pink-500"
                                        style="border: 1px solid #fff;border-radius: 10px;padding: 5px 35px;">
